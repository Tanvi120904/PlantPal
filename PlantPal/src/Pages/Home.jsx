...
import AppHeader from "../Components/AppHeader.jsx"; // The dynamic, fixed header
...
function Home() {
    ...
    // Function 1: Handles successful LOGIN and redirects to Dashboard
    const handleLoginSuccess = () => {
        setIsLoginModalOpen(false); 
        navigate('/dashboard'); 
    };

    // Function 2: Handles successful SIGNUP and transitions to the Login Modal
    ...
    return (
        <div className="home-page-container">
            ...
            {/* CORRECT: Only render the single, dynamic AppHeader component */}
            <AppHeader 
                onLoginClick={() => setIsLoginModalOpen(true)}
                onSignupClick={() => setIsModalOpen(true)}
            />

            {/* Main Hero Section (Static Content starts immediately after the fixed header) */}
            ...
            {/* Community Testimonials Section (Static Content) */}
            ...
            <SignupModal
                ...
                onSwitchToLogin={handleSignupToLogin} 
            />
        </div>
    );
}
